#!/bin/bash -e
# One-time host setup for this env, run via
...
# without root. There is no container here (see README.md), but this would
# still be needed on the host either way -- udev always runs there.
...
cat <<EOF
======================================================================
 zephyr-devshell-4.3.1-simple -- one-time host setup
======================================================================
...
env and no toolchain download is touched.
